...
html5.keywords = {
 ...
 tfoot th thead time title tr u ul video',
  ...
  irregular: 'area base br col command embed hr img input keygen link meta\
 ...
 nobr spacer tt',
  obsolete_irregular: 'basefont frame',
  special: 'tag text doctype' 
};
...
html5.irrTags = merge('irregular', 'obsolete_irregular');

  //console.log(html5.irrTags);
